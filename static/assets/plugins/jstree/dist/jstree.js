...
(function (factory) {
    ...
    //class属性的设置
    _temp1.className = 'btn btn-link';
    _temp1.setAttribute('href', '#');
    _temp2 = document.createElement('I');
    _temp2.className = 'fa fa fa-circle-o';
    ...
    $.jstree.core.prototype = {
        ...
        init: function (el, options) {
            ...
            this._data.core.original_container_html
                ...
                .remove();
            var my_html = "<" + "ul class='jstree-container-ul jstree-children' role='group' style='margin-top:10px' ><" + "li id='" + this._id + "' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='tree-item'><i class='jstree-icon jstree-ocl'></i><" + "a class='btn btn-white' href='' ><i class='fa fa fa-circle-o'></i>" + this.get_string("Loading ...") + "</a></li></ul>";
            this.element.html(my_html);
        ...
        redraw_node: function (node, deep, is_callback, force_render) {
            ...
            //_clickGroup函数
            if (!obj.a_attr.id) {
                obj.a_attr.onclick = "$._clickGroup(\'" + obj.id + "\')";
                obj.a_attr.style = "font-size:100%;"
            }
        ...
        refresh: function (skip_loading, forget_state) {
            ...
            console.log(c);
            var my_html = "<" + "ul class='" + c + "' role='group' style='margin-top:10px;' ><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' ><i class='fa fa fa-circle-o'></i>" + this.get_string("Loading ...") + "</a></li></ul>";
            if (!skip_loading) {
                this.element.html(my_html);
                this.element.attr('aria-activedescendant', 'j' + this._id + '_loading');
            }
